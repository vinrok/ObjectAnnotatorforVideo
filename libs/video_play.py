...
from libs.lib import distance, x_y_w_h
...
class VideoPlay(QLabel):
    ...
    def paintEvent(self, ev):
        ...
        x, y, w, h = x_y_w_h(self.lastPoint, self.endPoint)
        ...
        if cateNum > 0:
            ...
            for i in range(cateNum):
                x, y, w, h = x_y_w_h(self.lastPoint_list[i], self.endPoint_list[i])
                pp.drawRect(x, y, w, h)
